...
from dataset import Decision1Dataset
...
if args.do_train:
    train_dataset = Decision1Dataset(
            args.train_file, tokenizer, args.max_sequence_length,
            )

    dev_dataset = Decision1Dataset(
            args.dev_file, tokenizer, args.max_sequence_length,
            )
...
if args.do_eval:
    test_dataset = Decision1Dataset(
            args.test_file, tokenizer, args.max_sequence_length,
            )
